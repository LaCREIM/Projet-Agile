...
const StatistiquesEvaluation: React.FC = () => {
  ...
  const stats = useAppSelector(
    (state: RootState) => state.evaluations.statistiques
  );
              ...
              {questions.map((stat) => (
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-6 text-gray-700">
                    <p>
                      <strong>Minimal:</strong> {stat.minimal}
                    </p>
                    <p>
                      <strong>Maximal:</strong> {stat.maximal}
                    </p>
                    <p>
                      <strong>Moyenne:</strong>{" "}
                      {stat.moyennePositionnement.toFixed(2)}
                    </p>
                    <p>
                      <strong>Médiane:</strong>{" "}
                      {stat.medianPositionnement.toFixed(2)}
                    </p>
                    <p>
                      <strong>Nombre de réponses:</strong> {stat.nbReponses}
                    </p>
                  </div>
                  ...
                  <div className="w-[50%] mx-auto mt-6">
                    <Line
                      height={75}
                      data={{
                        labels: stat.totalPositionnements.map(
