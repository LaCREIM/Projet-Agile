  ...
  useEffect(() => {
    const filtered = evaluations.filter((evaluation) => {
      ...
      const matchesType = filterType
          ? (filterType === "Personnelle" && evaluation.evaluation.noEnseignant === Number(localStorage.getItem("id"))) ||
          (filterType === "Partagée" && evaluation.evaluation.noEnseignant !== Number(localStorage.getItem("id")))
          : true;
                ...
                paginatedEvaluations.map(
                    (evaluation: GetEvaluationDTO, index: number) => (
                        ...
                        >
                          ...
                          <td className="px-4 py-2">
                            {evaluation.evaluation.noEnseignant === Number(localStorage.getItem("id")) ? "Personnelle" : "Partagée"}
                          </td>
