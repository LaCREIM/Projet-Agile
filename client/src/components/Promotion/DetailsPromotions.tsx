      ...
      <div className="modal-box w-[55em] max-w-5xl space-y-5 hover:cursor-default">
        ...
        <div className="flex-grow overflow-auto">
          <dl className="grid grid-cols-1 gap-x-4 gap-y-8 sm:grid-cols-3 sm:col-gap-6 xl:grid-cols-2">
            ...
            <div className="text-base font-medium text-gray-900">
              <dt>Code Formation :</dt>
              <dd className="mt-1 text-gray-500">{promotion.codeFormation}</dd>
            </div>
            <div className="text-base font-medium text-gray-900">
              <dt>Formation :</dt>
              <dd className="mt-1 text-gray-500">{promotion.nomFormation}</dd>
            </div>
